...
export default function ReviewItem({ data }: ReviewItemProps) {
  ...
  return (
    <>
      <div
        key={id}
        className="review-item w-80 bg-background-main card-shadow overflow-hidden"
      >
        {thumbnail ? (
          <img
        ...
        <div className="review-data p-5 h-[227px] flex flex-col justify-between">
          <div className="review-post">
            {" "}
            <p className="review-title font-bold mb-4">
              {title}
              <span className="review-movie text-main ml-1.5">#{movie}</span>
            </p>
            <p className="review-content text-xs mb-4">{content}</p>
          ...
          <div className="review-social-buttons flex justify-around align-middle">
            <div className="like flex justify-center items-center">
              ...
              <span className="like-count text-xs ml-2">{like}</span>
            </div>
            <div className="comment flex justify-center items-center">
              ...
              <span className="comment-count text-xs ml-2">{comment}</span>
            </div>
            <div className="share">
