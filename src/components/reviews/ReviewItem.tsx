    ...
    return (
      ...
      >
        ...
        <div className="review-data p-5 flex flex-col justify-between h-[227px]">
          ...
          <Skeleton width={280} height={16} className="review-created-info" baseColor={skeletonBaseColor} highlightColor={skeletonHighlightColor} />
        ...
        <div className="review-data p-5 flex flex-col justify-between h-[227px]">
          <div className="review-post">
            ...
            <p className="review-created-info text-xs text-text-sub mb-4">
              ...
              by <span className="review-created-user text-main">{author}</span>
            </p>
          </div>
            ...
            <div className="like flex items-center">
              <button className="like-btn" onClick={handleLikeClick}>
                <svg width="18" height="18" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M8.89816 1.53033C13.7875 -3.1765 26.0119 5.05993 8.89816 15.6508C-8.21557 5.06096 4.00884 -3.1765 8.89816 1.53033Z" fill="black" fillOpacity="0.38"/>
                </svg>
              </button>
            ...
            <div className="comment flex items-center">
              <button className="comment-btn">
                <svg width="19" height="19" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M17.7709 1.8256C17.7709 0.917662 16.9865 0.174805 16.017 0.174805H1.9153C0.945808 0.174805 0.152588 0.917662 0.152588 1.8256V11.7304C0.152588 12.6383 0.945808 13.3812 1.9153 13.3812H14.2543L17.7797 16.6827L17.7709 1.8256Z" fill="black" fillOpacity="0.38"/>
                </svg>
              </button>
