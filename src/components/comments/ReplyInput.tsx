...
export default function ReplyInput({
  ...
  return (
    <>
      <div className="reply-input_container flex mt-2">
        ...
        <div className="reply-input flex flex-col w-full ml-2.5">
          <input
            type="text"
            placeholder="답글을 입력하세요"
            className="pl-1 pb-1 mt-1 mb-3 border-b border-text-light  placeholder:text-text-gborder-text-light focus:border-main-80 outline-0"
          />
