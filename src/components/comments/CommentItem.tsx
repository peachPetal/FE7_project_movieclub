...
export default function CommentItem({
  ...
  if (isLoading) return <CommentItemSkeleton />;
    ...
    return (
      <>
        <div className="comment-item flex mb-4">
          {comment.avatar_url ? (
            <img
          ...
          <div className="comment-item-content ml-2.5 w-full">
            <div className="comment-item-content_user flex items-center mt-1 mb-2">
              <span className="font-bold text-[20px] mr-2">
                {comment.author_name}
              </span>
