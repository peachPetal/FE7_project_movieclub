      ...
      <div className="comment-item flex">
        ...
        <div className="comment-item-content ml-2.5 w-full">
          <div className="comment-item-content_user flex items-center mb-2">
            <span className="font-bold text-[20px] mr-2">userName123</span>
            <span className="text-[15px] text-text-sub">5시간 전</span>
          </div>
          <p className="comment-item-content_text mb-2.5">
            마블 안 봤던 사람도 이 영화 보면 세계관 정주행하고 싶어질 듯 👍
          </p>
          ...
          {replyClicked ? <ReplyInput cancleBtnFn={onReplyBtnClick} /> : null}
          {replyCounter ? (
            <div className="reply-toggle">
              ...
              >
                <div className="flex items-center text-main">
                  ...
                  <span className="ml-2.5">답글 {replyCounter}개</span>
                </div>
              </button>
            </div>
          ) : null}
          {replyListClicked ? <ReplyList /> : null}
        </div>
      </div>
    </>
  );
